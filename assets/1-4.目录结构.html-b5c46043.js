import{_ as n,o as i,c as e,e as s}from"./app-277eb25d.js";const d={},l=s(`<p>一个 uni-app 工程，就是一个 Vue 项目。</p><h4 id="_1-目录结构-简洁版" tabindex="-1"><a class="header-anchor" href="#_1-目录结构-简洁版" aria-hidden="true">#</a> 1. 目录结构-简洁版</h4><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>┌─uniCloud              云空间目录
