import{_ as n,o as s,c as a,e as t}from"./app-68218236.js";const p="/front-doc/img/applet/uniapp/3-2-1.jpg",o={},e=t(`<h2 id="i-pages-json" tabindex="-1"><a class="header-anchor" href="#i-pages-json" aria-hidden="true">#</a> Ⅰ. pages.json</h2><ul><li>位置：根目录下</li><li>作用：对 uni-app 进行全局配置，决定页面文件的路径、窗口样式、原生的导航栏、底部的原生tabbar 等 <ul><li>navigator组件导航是，目标页面必须是在pages.json中注册的内部页面。</li><li>应用底部的tabbar对应的页面必须是在pages.json中注册的内部页面。</li></ul></li></ul><p>以下仅介绍常用配置项，详情见文档。</p><h4 id="_1-pages" tabindex="-1"><a class="header-anchor" href="#_1-pages" aria-hidden="true">#</a> 1. pages</h4><p>uni-app 通过 pages 节点配置应用由哪些页面组成，pages 节点接收一个数组，数组每个项都是一个对象。</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
